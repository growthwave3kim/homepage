			...
			<div className="mx-auto max-w-6xl">
				<div className="grid grid-cols-1 gap-10 lg:grid-cols-[1fr_520px] lg:gap-16 xl:gap-20">
					...
					<div className="flex flex-col justify-start lg:pt-10">
						{/* Why Us */}
						<p className="mb-4 font-semibold text-[#7c3aed] text-sm uppercase tracking-[0.2em]">
							Why us
						</p>
							...
							{REASONS.map((r) => (
								<div key={r.id} className="flex items-start gap-4">
									<div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-[#ede9fe]">
										<r.Icon className="h-5 w-5 text-[#7c3aed]" aria-hidden="true" />
									</div>
									<div>
						...
						<div className="space-y-3">
							<a
								...
								className="flex items-center gap-3 rounded-xl border border-slate-200 bg-white px-4 py-3.5 transition-colors hover:border-[#7c3aed]/40 hover:bg-[#7c3aed]/3"
							>
							...
							>
								<div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[#ede9fe]">
									<Mail className="h-5 w-5 text-[#7c3aed]" aria-hidden="true" />
								</div>
								<div>

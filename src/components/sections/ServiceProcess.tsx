				...
				<div ref={gridRef} className={`relative grid grid-cols-1 gap-10 md:gap-4 ${gridColsClass}`}>
					...
					{steps.map((item, i) => {
						...
						return (
							...
							>
								<div className="relative z-10 mb-5 flex h-20 w-20 items-center justify-center rounded-full border border-slate-200 bg-white shadow-[0_2px_8px_rgba(124,58,237,0.06)]">
									<span className="font-bold font-mono text-[#7c3aed] text-xl">{item.step}</span>
								</div>

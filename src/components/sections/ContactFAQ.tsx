...
const MINI_FAQS = [
	...
	{
		q: "계약하지 않아도 진단을 받을 수 있나요?",
		a: "네. 30분 무료 진단은 계약과 무관합니다. 진단 후 계약 여부를 자유롭게 결정하시면 됩니다.",
		href: "/faq",
	},
	{
		q: "성과까지 얼마나 걸리나요?",
		...
		<section className="bg-slate-50 px-4 py-14 md:py-16">
			<div className="mx-auto max-w-3xl">
				<Reveal className="mb-8">
					<p className="font-semibold text-[#7c3aed] text-sm uppercase tracking-[0.25em]">
						Quick FAQ
					</p>
				</Reveal>
					...
					{MINI_FAQS.map((faq, i) => (
						<Reveal key={faq.q} delay={i * 0.08}>
							<div className="rounded-xl bg-white p-5 shadow-[0_1px_8px_rgba(15,23,42,0.04)]">
								...
								<Link
									href={faq.href}
									className="inline-flex items-center gap-1 font-medium text-[#7c3aed] text-xs hover:underline"
								>
									FAQ에서 자세히 보기

...
const ImpactBar = ({
	...
	const annoColor = decrease ? "#059669" : "#7c3aed";
	const gradStart = decrease ? "#10b981" : "#7c3aed";
	const gradEnd = decrease ? "#059669" : "#8b5cf6";
	const afterTextFill = decrease ? "#059669" : "white";
		...
		<Reveal>
			<div className="overflow-hidden rounded-2xl bg-white shadow-[0_2px_32px_rgba(15,23,42,0.06)]">
				<div className="p-6 md:p-10">
					...
					{/* 한마디 */}
					<blockquote className="mb-5 border-[#7c3aed]/30 border-l-[3px] pl-5">
					...
					<p className="mb-8 break-keep text-lg text-slate-600 leading-relaxed md:text-xl">
						...
						<span className="font-extrabold text-2xl text-[#7c3aed] md:text-3xl">
		...
		<Reveal delay={index * 0.1}>
			<div className="flex h-full flex-col overflow-hidden rounded-2xl bg-white shadow-[0_2px_32px_rgba(15,23,42,0.06)]">
				<div className="flex flex-1 flex-col p-6 md:p-8">
					...
					{/* 한마디 */}
					<blockquote className="mb-4 border-[#7c3aed]/30 border-l-[3px] pl-4">
					...
					<p className="mb-5 break-keep text-base text-slate-600 leading-relaxed">
						{item.period} 후 월 상담{" "}
						<span className="font-extrabold text-[#7c3aed] text-xl">
							<CountUp to={item.multiplier} />배
						</span>{" "}
						증가!
					</p>
		...
		<section className="bg-slate-50 py-20 md:py-28">
			<div className="mx-auto max-w-5xl px-4 md:px-8">
				...
				<Reveal className="mb-10">
					<p className="mb-3 font-bold text-[#7c3aed] text-xl md:text-2xl">성공 사례</p>

					...
					<Reveal delay={0.1} direction="right">
						<div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
							<a
								...
								className="group flex items-center gap-3 rounded-xl border border-slate-200 bg-white px-5 py-4 transition-all hover:-translate-y-0.5 hover:border-[#7c3aed]/40 hover:shadow-[0_4px_16px_rgba(124,58,237,0.08)]"
							>
							...
							<Link
								href="/contact"
								className="group flex items-center gap-3 rounded-xl border border-[#7c3aed]/30 bg-[#7c3aed]/[0.04] px-5 py-4 transition-all hover:-translate-y-0.5 hover:bg-[#7c3aed]/[0.08]"
							>
								<div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-[#7c3aed]">
									<ArrowRight className="h-4 w-4 text-white" aria-hidden="true" />
								</div>
								<div>
									<p className="font-semibold text-[#7c3aed] text-sm">마케팅 컨설팅</p>

			...
			<div className="mx-auto max-w-6xl">
				<div className="grid grid-cols-1 gap-12 md:grid-cols-2 md:gap-16">
					<Reveal direction="left">
						<p className="mb-2 font-semibold text-[#7c3aed] text-sm uppercase tracking-[0.25em]">
							Engagement Policy
						</p>
						...
						<div className="grid grid-cols-2 gap-4">
							{SIGNATURE_POINTS.map((pt, i) => (
								<motion.div
									...
									whileHover={{ borderColor: "rgba(124,58,237,0.4)", y: -4 }}
								>
									<span className="mb-2 block font-bold font-mono text-[#7c3aed] text-xs tracking-[0.15em]">
										{pt.num}
									</span>

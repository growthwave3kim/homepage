			...
			<div className="mx-auto max-w-5xl">
				...
				<div ref={gridRef} className="grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-5">
					{ITEMS.map((item, i) => (
						...
						>
							<div className="group relative flex min-h-[260px] flex-col justify-between overflow-hidden rounded-2xl border border-slate-200 bg-white p-8 transition-all duration-500 hover:-translate-y-1.5 hover:border-[#7c3aed]/20 hover:bg-[#faf8ff] hover:shadow-[0_16px_48px_rgba(124,58,237,0.12)]">
								{/* 왼쪽 gradient 세로선 */}
								<div className="absolute inset-y-0 left-0 w-[3px] rounded-l-2xl bg-linear-to-b from-[#7c3aed] to-[#4338ca] opacity-40 transition-opacity duration-500 group-hover:opacity-100" />

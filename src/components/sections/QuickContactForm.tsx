...
export default function QuickContactForm() {
	...
	return (
		<div className="rounded-2xl border border-[#7c3aed]/20 bg-white p-8 shadow-sm">
			...
			<AnimatePresence mode="wait">
				{sent ? (
					...
					>
						<div className="gradient-brand flex h-14 w-14 items-center justify-center rounded-full">
							<CheckCircle2 className="h-7 w-7 text-white" />
						</div>
						<p className="font-semibold text-foreground">접수되었습니다</p>
					...
					<motion.form key="form" onSubmit={handleSubmit} onKeyDown={handleKeyDown} className="space-y-4">
						...
						<div className="space-y-1.5">
							<Label htmlFor="quick-message">
								문의 내용 <span className="font-normal text-red-400">*</span>
							</Label>
							<Input
								id="quick-message"
								name="message"
						...
						<button
							type="submit"
							className="gradient-brand w-full rounded-xl py-3.5 font-semibold text-sm text-white shadow-[0_4px_20px_rgba(124,58,237,0.25)] transition-opacity hover:opacity-90"
						>
							바로 문의하기
						</button>

...
export const FaqHero = () => {
	...
	return (
		<section className="relative flex min-h-screen items-center overflow-hidden bg-[#fafbfc] px-6 py-28 md:px-10 md:py-36">
			{/* Soft tinted blobs */}
			<div
				className="pointer-events-none absolute top-[-10%] left-[-10%] h-[600px] w-[600px] rounded-full bg-[#7c3aed] opacity-[0.05] blur-[160px]"
				aria-hidden="true"
			/>
			<div
				className="pointer-events-none absolute right-[-8%] bottom-[-10%] h-[500px] w-[500px] rounded-full bg-[#06b6d4] opacity-[0.05] blur-[140px]"
				aria-hidden="true"
			/>

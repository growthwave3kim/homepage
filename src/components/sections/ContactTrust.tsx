					...
					<Reveal delay={0.1} direction="right">
						...
						<div className="space-y-3">
							<a
								...
								className="flex items-center gap-3 rounded-xl border border-slate-200 bg-slate-50 px-4 py-3.5 transition-colors hover:border-[#7c3aed]/30 hover:bg-[#7c3aed]/[0.03]"
							>

...
export const ContactHero = () => {
	...
	return (
		<section className="relative flex min-h-screen items-center overflow-hidden bg-white px-6 py-28 md:px-10 md:py-36">
			{/* Purple orb — top-left */}
			<div
				className="pointer-events-none absolute -top-[15%] -left-[10%] h-[600px] w-[600px] rounded-full bg-[#7c3aed] opacity-[0.06] blur-[160px]"
				aria-hidden="true"
			/>
			{/* Cyan orb — bottom-right */}
			<div
				className="pointer-events-none absolute -right-[8%] -bottom-[10%] h-[400px] w-[400px] rounded-full bg-[#06b6d4] opacity-[0.04] blur-[140px]"
				aria-hidden="true"
			/>

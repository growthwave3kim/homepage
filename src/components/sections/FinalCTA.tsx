	...
	return (
		<section className="relative overflow-hidden bg-[#100d18] px-4 py-28 md:py-36">
			...
			<div className="pointer-events-none absolute inset-0">
				<div className="absolute top-1/2 left-1/2 h-[620px] w-[960px] -translate-x-1/2 -translate-y-1/2 bg-[radial-gradient(ellipse_at_center,rgba(124,58,237,0.34),transparent_68%)]" />
				...
				<div className="absolute -bottom-32 left-1/4 h-72 w-72 rounded-full bg-[#06b6d4] opacity-[0.06] blur-[120px]" />
			</div>
			...
			<div className="relative mx-auto max-w-3xl text-center">
				<Reveal>
					<p className="mb-5 font-mono text-[#a78bfa] text-xs uppercase tracking-[0.35em]">
						문의하기
					</p>
					...
					<div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
						<Link
							href="/contact"
							className="gradient-brand w-full rounded-xl px-8 py-4 font-bold text-base text-white shadow-[0_8px_32px_rgba(124,58,237,0.45)] transition-all hover:scale-[1.03] hover:shadow-[0_12px_40px_rgba(124,58,237,0.6)] sm:w-auto"
						>
							문의하기
						</Link>
						<a

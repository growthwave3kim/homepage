								...
								<div key={cat} id={categoryDomId(cat)} className="mb-14 scroll-mt-28 last:mb-0">
									<div className="mb-6 flex items-center justify-between">
										<div className="flex items-center gap-3">
											<span className="inline-flex h-9 w-9 items-center justify-center rounded-md bg-[#7c3aed]/15 text-[#7c3aed]">
												<Icon className="h-5 w-5" aria-hidden="true" />
											</span>
											<div>
												<p className="mb-1 font-mono text-[#7c3aed] text-xs uppercase tracking-[0.25em]">
													{CATEGORY_SLUGS[cat]}
												</p>

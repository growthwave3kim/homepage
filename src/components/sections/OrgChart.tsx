				...
				<Reveal direction="scale" delay={0.1}>
					<div className="flex justify-center">
						<div className="w-full max-w-xs">
							<div className="rounded-2xl bg-linear-to-br from-[#7c3aed] to-[#5b21b6] px-8 py-7 text-center shadow-[0_4px_24px_rgba(124,58,237,0.3)]">
						...
						<Reveal key={dept.name} direction={deptDirs[i]} delay={0.35 + i * 0.1}>
							<div className="flex flex-col">
								...
								<div className="flex flex-col md:px-2">
									<div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm transition-all duration-200 hover:border-[#7c3aed]/30 hover:shadow-md">

...
export const ReviewCardPhone = ({ review }: Props) => {
	return (
		<div className="relative flex shrink-0 flex-col items-center">
			{/* Phone outer frame */}
			<div className="relative h-[420px] w-[200px] rounded-[36px] border-[#0a0a0a] border-[7px] bg-[#0a0a0a] p-1 md:h-[480px] md:w-[230px]">
				{/* Notch */}
				<div className="absolute top-0 left-1/2 z-10 h-5 w-20 -translate-x-1/2 rounded-b-2xl bg-[#0a0a0a]" />

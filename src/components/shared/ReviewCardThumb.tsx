...
export const ReviewCardThumb = ({ review }: Props) => {
	return (
		<div className="flex w-[260px] shrink-0 flex-col overflow-hidden rounded-md border border-slate-200 bg-white transition-all hover:-translate-y-1 hover:shadow-[0_8px_24px_rgba(124,58,237,0.10)] md:w-[290px]">
			{/* Image area */}
